...
func (g GenesisAccount) MarshalJSON() ([]byte, error) {
	type GenesisAccount struct {
		...
		SecurityLevel math.HexOrDecimal64      `json:"security,omitempty"`
	...
	enc.SecurityLevel = math.HexOrDecimal64(g.SecurityLevel)
...
func (g *GenesisAccount) UnmarshalJSON(input []byte) error {
	...
	if dec.SecurityLevel != nil {
		g.SecurityLevel = uint64(*dec.SecurityLevel)
	}
